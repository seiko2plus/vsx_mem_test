...
/test/samples/vsx_mem.c.power8_clang-8.o:     file format elf64-powerpcle
...
0000000000000000 <INTRIN_ushort>:
  ...
  18:	00 00 00 60 	nop
  1c:	00 00 00 60 	nop
  20:	99 26 40 7c 	lxvd2x  vs34,0,r4
  24:	99 2e 60 7c 	lxvd2x  vs35,0,r5
  28:	08 00 e7 38 	addi    r7,r7,8
  2c:	10 00 a5 38 	addi    r5,r5,16
  30:	10 00 84 38 	addi    r4,r4,16
  34:	40 30 27 7c 	cmpld   r7,r6
  38:	40 10 43 10 	vadduhm v2,v3,v2
  3c:	99 1f 40 7c 	stxvd2x vs34,0,r3
...
0000000000000060 <INTRIN_short>:
  ...
  78:	00 00 00 60 	nop
  7c:	00 00 00 60 	nop
  80:	99 26 40 7c 	lxvd2x  vs34,0,r4
  84:	99 2e 60 7c 	lxvd2x  vs35,0,r5
  88:	08 00 e7 38 	addi    r7,r7,8
  8c:	10 00 a5 38 	addi    r5,r5,16
  90:	10 00 84 38 	addi    r4,r4,16
  94:	40 30 27 7c 	cmpld   r7,r6
  98:	40 10 43 10 	vadduhm v2,v3,v2
  9c:	99 1f 40 7c 	stxvd2x vs34,0,r3
...
00000000000000c0 <INTRIN_uint>:
  ...
  d8:	00 00 00 60 	nop
  dc:	00 00 00 60 	nop
  e0:	99 26 40 7c 	lxvd2x  vs34,0,r4
  e4:	99 2e 60 7c 	lxvd2x  vs35,0,r5
  e8:	04 00 e7 38 	addi    r7,r7,4
  ec:	10 00 a5 38 	addi    r5,r5,16
  f0:	10 00 84 38 	addi    r4,r4,16
  f4:	40 30 27 7c 	cmpld   r7,r6
  f8:	80 10 43 10 	vadduwm v2,v3,v2
  fc:	99 1f 40 7c 	stxvd2x vs34,0,r3
...
0000000000000120 <INTRIN_int>:
 ...
 138:	00 00 00 60 	nop
 13c:	00 00 00 60 	nop
 140:	99 26 40 7c 	lxvd2x  vs34,0,r4
 144:	99 2e 60 7c 	lxvd2x  vs35,0,r5
 148:	04 00 e7 38 	addi    r7,r7,4
 14c:	10 00 a5 38 	addi    r5,r5,16
 150:	10 00 84 38 	addi    r4,r4,16
 154:	40 30 27 7c 	cmpld   r7,r6
 158:	80 10 43 10 	vadduwm v2,v3,v2
 15c:	99 1f 40 7c 	stxvd2x vs34,0,r3
...
0000000000000180 <DEREF_ushort>:
 ...
 1ac:	10 00 a5 38 	addi    r5,r5,16
 1b0:	10 00 84 38 	addi    r4,r4,16
...
00000000000001e0 <DEREF_short>:
 ...
 1f8:	00 00 00 60 	nop
 1fc:	00 00 00 60 	nop
 200:	ce 20 40 7c 	lvx     v2,0,r4
 204:	ce 28 60 7c 	lvx     v3,0,r5
 208:	08 00 e7 38 	addi    r7,r7,8
 20c:	10 00 a5 38 	addi    r5,r5,16
 210:	10 00 84 38 	addi    r4,r4,16
 214:	40 30 27 7c 	cmpld   r7,r6
 218:	40 10 43 10 	vadduhm v2,v3,v2
 21c:	ce 19 40 7c 	stvx    v2,0,r3
...
0000000000000240 <DEREF_uint>:
 ...
 258:	00 00 00 60 	nop
 25c:	00 00 00 60 	nop
 260:	ce 20 40 7c 	lvx     v2,0,r4
 264:	ce 28 60 7c 	lvx     v3,0,r5
 268:	04 00 e7 38 	addi    r7,r7,4
 26c:	10 00 a5 38 	addi    r5,r5,16
 270:	10 00 84 38 	addi    r4,r4,16
 274:	40 30 27 7c 	cmpld   r7,r6
 278:	80 10 43 10 	vadduwm v2,v3,v2
 27c:	ce 19 40 7c 	stvx    v2,0,r3
...
00000000000002a0 <DEREF_int>:
 ...
 2b8:	00 00 00 60 	nop
 2bc:	00 00 00 60 	nop
 2c0:	ce 20 40 7c 	lvx     v2,0,r4
 2c4:	ce 28 60 7c 	lvx     v3,0,r5
 2c8:	04 00 e7 38 	addi    r7,r7,4
 2cc:	10 00 a5 38 	addi    r5,r5,16
 2d0:	10 00 84 38 	addi    r4,r4,16
 2d4:	40 30 27 7c 	cmpld   r7,r6
 2d8:	80 10 43 10 	vadduwm v2,v3,v2
 2dc:	ce 19 40 7c 	stvx    v2,0,r3
