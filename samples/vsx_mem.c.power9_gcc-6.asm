...
0000000000000050 <INTRIN_short>:
  ...
  5c:	00 00 00 60 	nop
  60:	09 00 04 f4 	lxv     vs32,0(r4)
  64:	09 00 25 f4 	lxv     vs33,0(r5)
  68:	08 00 29 39 	addi    r9,r9,8
  6c:	10 00 63 38 	addi    r3,r3,16
  70:	10 00 84 38 	addi    r4,r4,16
  74:	10 00 a5 38 	addi    r5,r5,16
  78:	40 48 a6 7f 	cmpld   cr7,r6,r9
  7c:	40 08 00 10 	vadduhm v0,v0,v1
  80:	fd ff 03 f4 	stxv    vs32,-16(r3)
...
00000000000000a0 <INTRIN_int>:
  ...
  ac:	00 00 00 60 	nop
  b0:	09 00 04 f4 	lxv     vs32,0(r4)
  b4:	09 00 25 f4 	lxv     vs33,0(r5)
  b8:	04 00 29 39 	addi    r9,r9,4
  bc:	10 00 63 38 	addi    r3,r3,16
  c0:	10 00 84 38 	addi    r4,r4,16
  c4:	10 00 a5 38 	addi    r5,r5,16
  c8:	40 48 a6 7f 	cmpld   cr7,r6,r9
  cc:	80 08 00 10 	vadduwm v0,v0,v1
  d0:	fd ff 03 f4 	stxv    vs32,-16(r3)
...
00000000000000f0 <INTRIN_double>:
 ...
 104:	01 00 85 f5 	lxv     vs12,0(r5)
 108:	02 00 29 39 	addi    r9,r9,2
 10c:	10 00 63 38 	addi    r3,r3,16
 110:	10 00 84 38 	addi    r4,r4,16
 114:	10 00 a5 38 	addi    r5,r5,16
 118:	40 48 a6 7f 	cmpld   cr7,r6,r9
 11c:	00 63 00 f0 	xvadddp vs0,vs0,vs12
 120:	f5 ff 03 f4 	stxv    vs0,-16(r3)
